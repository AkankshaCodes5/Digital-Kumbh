      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          <Button
            variant="ghost"
            size="sm"
            className="bg-white text-pilgrim-orange hover:bg-gray-100 text-xs sm:text-sm px-3 sm:px-4 h-8 sm:h-10"
...
<section
  className="relative text-white py-16 sm:py-20 md:py-24 bg-center bg-cover min-h-[400px] sm:min-h-[500px] flex items-center"
  style={{
...
>
  <div className="container mx-auto px-3 sm:px-4 md:px-6 pt-20 sm:pt-24">
    <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-10 max-w-4xl">
      <div className="w-full md:w-1/2 mb-6 sm:mb-8 md:mb-0 text-center md:text-left">
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-6 sm:mb-8 max-w-lg mx-auto md:mx-0 leading-relaxed">
        ...
        <div className="flex justify-center md:justify-start">
          <Button 
            size="lg" 
            className="bg-white text-pilgrim-orange hover:bg-gray-100 font-semibold shadow-md text-sm sm:text-base px-6 sm:px-8"
            onClick={() => navigate('/signup')}
          >
            Get Started
          </Button>
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/30 pointer-events-none"></div>
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="container mx-auto px-3 sm:px-4 md:px-6">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-pilgrim-brown mb-3 sm:mb-4">
          ...
          <Tabs defaultValue="pilgrims" className="w-full max-w-4xl mx-auto">
            <TabsList className="grid w-full grid-cols-3 mb-6 sm:mb-8 h-auto p-1">
              <TabsTrigger value="pilgrims" className="text-xs sm:text-sm py-2 px-2 sm:px-4">For Pilgrims</TabsTrigger>
              <TabsTrigger value="authorities" className="text-xs sm:text-sm py-2 px-2 sm:px-4">For Authorities</TabsTrigger>
              <TabsTrigger value="admin" className="text-xs sm:text-sm py-2 px-2 sm:px-4">For Admins</TabsTrigger>
            </TabsList>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-md">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-orange-100 flex items-center justify-center mb-3 sm:mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 sm:w-6 sm:h-6 text-pilgrim-orange">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-pilgrim-brown">
            ...
            <TabsContent value="authorities" className="animate-fade-in">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-md">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-pilgrim-brown">Real-time Crowd Monitoring</h3>
                  <p className="text-sm sm:text-base text-gray-600">Monitor crowd density from CCTV feeds and dashboards to prevent congestion.</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-md">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-pilgrim-brown">Rapid Alert Broadcasts</h3>
                  <p className="text-sm sm:text-base text-gray-600">Push emergency and crowd-control alerts to ground teams and screens instantly.</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-md">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-pilgrim-brown">Missing Person Matching</h3>
                  <p className="text-sm sm:text-base text-gray-600">Use AI-assisted search to match new reports with sightings and CCTV detections.</p>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="admin" className="animate-fade-in">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-md">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-pilgrim-brown">User Management & Roles</h3>
                  <p className="text-sm sm:text-base text-gray-600">Manage authorities, operators, and user permissions with fine-grained roles.</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-md">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-pilgrim-brown">System Analytics & Reports</h3>
                  <p className="text-sm sm:text-base text-gray-600">Track incident trends, response times, and operational KPIs across the system.</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-md">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-pilgrim-brown">Configuration & Permissions</h3>
                  <p className="text-sm sm:text-base text-gray-600">Configure integrations, safety thresholds, and global settings with audit trails.</p>
                </div>
              </div>
            </TabsContent>
          </Tabs>
      ...
      <section className="py-12 sm:py-16 bg-white text-center">
        <div className="container mx-auto px-3 sm:px-4 md:px-6">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto mb-6 sm:mb-8 px-2">
          ...
          <div className="flex justify-center">
            <Button 
              size="lg" 
              className="pilgrim-gradient hover:opacity-90 text-sm sm:text-base px-6 sm:px-8"
              onClick={() => navigate('/signup')}
            >
              Create Free Account
            </Button>
